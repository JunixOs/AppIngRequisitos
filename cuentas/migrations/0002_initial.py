...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="Cuenta principal (opcional para subcuentas independientes)",
                null=True,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="transferencias_desde_subcuentas",
                to="cuentas.cuenta",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="transferencias_cuenta_principal",
                to="cuentas.subcuenta",
            ),
        ),
        migrations.AddField(
