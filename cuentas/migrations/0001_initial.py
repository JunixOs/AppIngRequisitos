# Generated by Django 5.2 on 2025-07-07 14:37
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nombre",
                    models.CharField(
                        help_text="Nombre descriptivo de la subcuenta", max_length=50
                    ),
                ),
                (
                    "descripcion",
                    models.CharField(
                        blank=True,
                        help_text="Propósito y objetivo de esta subcuenta",
                        max_length=300,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=0,
                        help_text="Saldo actual en la subcuenta",
                        max_digits=15,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        default="otros",
                        help_text="Categoría de la subcuenta",
                        max_length=30,
                    ),
                ),
                (
                ...
                (
                    "activa",
                    models.BooleanField(
                        default=True, help_text="Indica si la subcuenta está activa"
                    ),
                ),
                ...
                (
                    "es_negocio",
                    models.BooleanField(
                        default=False, help_text="Marca si es una subcuenta de negocio"
                    ),
                ),
                (
                    "meta_objetivo",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Meta de ahorro u objetivo financiero",
                        max_digits=15,
                        null=True,
                    ),
                ),
